...
public class VerificationActivityauto extends AppCompatActivity implements
...
SharedPreferences shh;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verificationauto);
...
//                            .message("##OTP## is Your verification digits.")//##OTP## use for default generated OTP
    ...
    public void onVerified(String response) {
        //DataManaer.getInstance().hideProgressMessage();
      startActivity(new Intent(VerificationActivityauto.this,Registrationauto.class));
    }
    ...
    private void startTimer() {
        resend_timer.setClickable(false);
        resend_timer.setTextColor(ContextCompat.getColor(VerificationActivityauto.this, R.color.white));
        new CountDownTimer(30000, 1000) {
            ...
            public void onFinish() {
                ...
                resend_timer.setTextColor(ContextCompat.getColor(VerificationActivityauto.this, R.color.send_otp_blue));
            }
        }.start();
    }
